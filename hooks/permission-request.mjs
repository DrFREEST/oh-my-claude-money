#!/usr/bin/env node
/**
 * permission-request.mjs - PermissionRequest 이벤트 안전 패스스루
 *
 * 권한 요청 이벤트를 최소 로깅/상태 저장한 뒤 항상 continue 처리합니다.
 */
...
var EVENT_NAME = 'PermissionRequest';
...
function getCommand(input) {
  ...
  if (input && input.toolInput && typeof input.toolInput.command === 'string') {
