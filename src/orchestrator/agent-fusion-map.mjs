 ...
 *
 * OMC v4.1.3 호환 - Codex fallback chain 반영
 *
 * 티어별 모델 분배:
...
export const MODELS = {
  ...
  // OMC 4.1.3 fallback chain: gpt-5.3-codex → gpt-5.3 → gpt-5.2-codex → gpt-5.2
  CODEX: {
    provider: 'openai',
    model: 'gpt-5.3-codex',
    thinking: true,
...
// =============================================================================
// OMC → OMO 에이전트 퓨전 매핑 (28개 + 2 alias) - OMC v4.1.3 호환
// =============================================================================
...
export function shouldUseFusionMapping(fusionState) {
  ...
  // team 모드가 활성화된 경우 (OMC 4.1.3, was hulw)
