/**
 * model-advisor.mjs - OMC v4.2.15 모델 최적화 어드바이저
 *
 * 작업 복잡도 분석 및 모델 다운그레이드 추천을 통해
 * 비용 최적화를 지원합니다.
 *
 * OMC 4.2.15 Codex fallback chain 반영:
...
export var MODEL_COSTS = {
  ...
  'claude-sonnet-4-6-20260217': { input: 0.003, output: 0.015, tier: 'MEDIUM' },
  'claude-haiku-4-5-20251001': { input: 0.0008, output: 0.004, tier: 'LOW' },

  // OpenAI - OMC 4.2.15 fallback chain
...
export function analyzeTaskComplexity(task) {
  ...
  // 에이전트 기반 복잡도 (OMC 4.2.15 Lane 기반)
